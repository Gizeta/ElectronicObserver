	...
	public static class WindowPlacementManager {
		...
		public static void LoadWindowPlacement( FormMain form, string path ) {
			...
			try {
				...
				Utility.ErrorReporter.SendErrorReport( ex, Properties.Resources.WindowPlacementManager_LoadError );
		...
		public static void SaveWindowPlacement( FormMain form, string path ) {
			...
			try {
				...
				Utility.ErrorReporter.SendErrorReport( ex, Properties.Resources.WindowPlacementManager_SaveError );
			}
		}
