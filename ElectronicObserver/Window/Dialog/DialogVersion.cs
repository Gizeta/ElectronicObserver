...
namespace ElectronicObserver.Window.Dialog {
	public partial class DialogVersion : Form {
		public DialogVersion() {
			...
			TextVersion.Text = string.Format( "{0} (ver. {1} - {2} Release)", SoftwareInformation.Version, SoftwareInformation.VersionEnglish, SoftwareInformation.UpdateTime.ToString( "d" ) ); 
		}
