...
namespace ElectronicObserver.Observer.kcsapi.api_req_map {
	...
	public class start : APIBase {
		...
		public override void OnRequestReceived( Dictionary<string, string> data ) {
			...
			Utility.Logger.Add( 2, string.Format( Properties.Resources.APIMapStart_Message, deckID, KCDatabase.Instance.Fleet[deckID].Name, maparea, mapinfo, KCDatabase.Instance.MapInfo[maparea * 10 + mapinfo].Name ) );
