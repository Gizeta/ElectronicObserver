	...
	public class start : APIBase {
		...
		public override void OnRequestReceived( Dictionary<string, string> data ) {
			...
			*/
			...
			Utility.Logger.Add( 2, string.Format( Properties.Resources.APIMissionStart_Message, deckID, KCDatabase.Instance.Fleet[deckID].Name, destination, KCDatabase.Instance.Mission[destination].Name ) );
