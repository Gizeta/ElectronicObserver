	...
	public partial class FormBrowser : Form, IBrowser {
		...
		private void SaveScreenShot( string path, System.Drawing.Imaging.ImageFormat format ) {
			...
			try {
				...
				if ( document == null ) {
					throw new InvalidOperationException( Properties.Resources.Browser_InaccessableDocument );
				}
				...
				if ( document.url.Contains( ".swf?" ) ) {
					...
					if ( gameFrame == null ) {
						throw new InvalidOperationException( Properties.Resources.Browser_InaccessableGameFrame );
					}
